...
//      [2_3_b] When the ball falls down and touches the right of the paddle (ball left, paddle right) (no squeezed) 
		...
		BallState myNewBall2_3_b = new BallState(new Point(25000,23100),new Point(25700,23800), new Vector(7,7));
		...
		assertEquals(myBreakoutState2_3_b.getBalls()[0].getTl(),new Point(25000,23100));
		assertEquals(myBreakoutState2_3_b.getBalls()[0].getBr(),new Point(25700,23800));
...
//		[5] move paddle left to WallLeft
		...
		System.out.println(myBreakoutState5.getPaddle().getTl());
		System.out.println(myBreakoutState5.getPaddle().getBr());
		System.out.println(myBreakoutState5.getPaddle().getVelocity());
		BreakoutState myNewBreakoutState5 = new BreakoutState(myBalls,myBlocks,myBottomRight, myNewPaddle5);
		System.out.println(myNewBreakoutState5.getPaddle().getTl());
